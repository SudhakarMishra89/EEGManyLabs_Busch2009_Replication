function RunExperiment(Name)
 ...
 try
    ...
    cross_arm_length = 22.5; %rs changed to 22.5 from 10
    cross_gap = 56.25; %rs changed to 56.25 from 25
    cross_color = [35 35 35];
    line_width = 3; %rs changed to 3 from 1
    ...
    left_target_coords = [...
            LeftEccentricity-7.8 * PixelsPerDegree/60 ...
            centery-7.8 * PixelsPerDegree/60 ...
            LeftEccentricity+7.8 * PixelsPerDegree/60 ...
            centery+7.8 * PixelsPerDegree/60
    ];
    right_target_coords = [...
            RightEccentricity-7.8 * PixelsPerDegree/60 ...
            centery-7.8 * PixelsPerDegree/60 ...
            RightEccentricity+7.8 * PixelsPerDegree/60 ...
            centery+7.8 * PixelsPerDegree/60
    ];
    ...
    Screen( 'TextSize', FixCross, 28 );  % r&s changed from 7 to 28
    FixString = '+';
    ...
    leftcuebmp = imresize(leftcuebmp,0.18); % r&s changed from 0.08 to 0.18
    ...
    rightcuebmp = imresize(rightcuebmp,0.18); % r&s changed from 0.08 to 0.18
